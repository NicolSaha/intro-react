    ...
    return(
        <div className="border-t border-gray-200 mt-4 px-4 py-4 sm:px-6">
            <label htmlFor="selectTodosCategory"
                   className="block text-sm leading-5 font-medium text-white">Todos Category</label>

            <select onChange={statusHandler} id="selectTodosCategory"
